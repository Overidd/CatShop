...
export const Footer = () => {
   return (
      <footer className="bg-bgPrimary relative pb-8">

         <div className="w-full absolute z-10 bottom-[100%] md:bottom-[80%] ">
         ...
         <div className="relative z-20 w-[90%] m-auto flex gap-10 flex-col items-baseline flex-wrap md:flex-row md:text-xl">
            ...
            <p className="text-center text-white text-sm basis-[100%]">
